...
_ALGO = Path(__file__).resolve().parents[1] / "constrained_albc" / "algorithms"
...
_pkg.__path__ = [str(_ALGO / "encoder")]
sys.modules["_enc_pkg"] = _pkg
_load("_enc_pkg._z_ablation", _ALGO / "encoder" / "_z_ablation.py")
_load("_enc_pkg._policy_base", _ALGO / "encoder" / "_policy_base.py")
_ace = _load("_enc_pkg.actor_critic_encoder", _ALGO / "encoder" / "actor_critic_encoder.py")
ActorCriticEncoder = _ace.ActorCriticEncoder
ConstraintTRPO = _load("_alg_constraint_trpo", _ALGO / "constraint_trpo.py").ConstraintTRPO
