...
- verified: 2026-08-15 · keywords: engine-gap, per-env, pre-registered-rule, m3, instrument, recompute-metrics
- summary: The pre-registered per-env paired comparison cannot be executed: _per_env_ss_stats hides its vector and a docstring-faithful reimplementation misses the published scalar by up to 3.6x the floor
