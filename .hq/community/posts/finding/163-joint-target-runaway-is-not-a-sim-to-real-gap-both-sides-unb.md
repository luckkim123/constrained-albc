...
- verified: 2026-08-21 · keywords: albc, arm, joint, vibration, sim-to-real, deployment
- summary: Joint target runaway is NOT a sim-to-real gap (both sides unbounded); the real asymmetry is the accumulator reset
