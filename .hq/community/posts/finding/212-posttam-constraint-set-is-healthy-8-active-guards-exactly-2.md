...
- verified: 2026-07-22 · keywords: constraint, slack, rp_vel_settling, manipulability, p-d1, p-d2
- summary: Posttam constraint set is healthy: 8 active guards + exactly 2 dormant (rp_vel_settling, manipulability)
