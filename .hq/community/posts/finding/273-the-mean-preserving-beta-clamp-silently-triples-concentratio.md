...
- verified: 2026-07-29 · keywords: doraemon, curriculum, beta, init_concentration, fault_severity, clamp
- summary: The mean-preserving Beta clamp silently triples concentration for nominal-0 DR dims (30 -> 100), and those 4 dims are exactly the ones that end under-expanded
