...
- verified: none · keywords: albc, doraemon, kl_ub, curriculum, saturation, expansion-budget
- summary: Halving kl_ub cost 1.42x iterations to saturation, not the 2x the trust-region model predicts -- and trajectory retention blocks closing the confound
