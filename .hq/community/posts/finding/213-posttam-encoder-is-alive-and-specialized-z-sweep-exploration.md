...
- verified: none · keywords: encoder, z-sweep, exploration, doraemon, p-a1, auto-captured
- summary: Posttam encoder is alive and specialized (z-sweep) — exploration collapse is a converged optimum, not a dead encoder
