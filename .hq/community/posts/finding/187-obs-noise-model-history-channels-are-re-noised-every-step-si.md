...
- verified: 2026-07-20 · keywords: obs-noise, sim2real, observation, history
- summary: Obs-noise model: history channels are re-noised every step (sim past is not frozen like hardware)
