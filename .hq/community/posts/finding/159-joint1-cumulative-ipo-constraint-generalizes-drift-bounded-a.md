...
- verified: none · keywords: joint1, OOD, heavy-tail, roll, generalization, drift
- summary: joint1_cumulative IPO constraint generalizes (drift bounded at OOD) while the attitude tracker does not (roll OOD heavy-tail)
