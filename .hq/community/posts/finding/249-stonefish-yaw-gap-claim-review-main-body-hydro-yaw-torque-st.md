...
- verified: 2026-08-05 · keywords: sim-to-real, stonefish, yaw, hydrodynamics, munk-moment, added-mass
- summary: Stonefish yaw-gap claim review: main-body hydro yaw torque structurally zero (symmetric added mass kills Munk); PhysX DOES model arm reaction; real gaps = buoy added-mass ~10x under, no arm-link hydro, no yaw-torque DR axis
