...
- verified: 2026-07-30 · keywords: distillation, student, latent, multimodality, diffusion-rejection, albc
- summary: Student distillation converges to a residual that rules out latent multimodality (teacher-visited distribution only)
