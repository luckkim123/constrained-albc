...
- verified: 2026-07-30 · keywords: stonefish, hydrodynamics, system-id, damping, added-mass, sim-to-real
- summary: Stonefish base-hull effective hydro MEASURED (2026-07-27): damping is the gap axis (yaw ~45-100x, pitch-linear ~10x, translational 3-8x under nominal); effective added inertia already matches; nominals recentered on marinelab exp/hydro-recenter
