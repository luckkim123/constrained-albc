...
- verified: 2026-07-05 · keywords: albc, envs-main, command-resample, leaky-integral, bias-ema, carry-over
- summary: Leaky-integral and EMA-bias carry over the mid-episode command resample (unexamined side-effect, harm unproven, A/B design ready)
