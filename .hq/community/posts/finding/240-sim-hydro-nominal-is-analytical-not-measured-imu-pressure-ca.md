...
- verified: 2026-08-05 · keywords: measurement, system-id, domain-randomization, sim-to-real, damping, free-decay
- summary: sim hydro nominal is analytical (not measured); IMU+pressure can anchor rotation/heave but not surge/sway/TAM
