...
- verified: 2026-08-21 · keywords: sim2real, agent-jetson, policy, latency, arm, open-lead
- summary: OPEN: on land the policy winds J2 to pi and beyond, and the board feeds it IMU at 20 Hz / joints at 10 Hz against a 50 Hz control loop
