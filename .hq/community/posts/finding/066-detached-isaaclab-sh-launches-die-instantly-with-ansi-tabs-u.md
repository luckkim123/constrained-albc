...
- verified: 2026-08-10 · keywords: albc, launch, isaaclab, term, detached, nohup
- summary: Detached isaaclab.sh launches die instantly with ansi+tabs unknown terminal type unless TERM is set -- and every health probe reads it as a clean finish
