...
- verified: 2026-07-11 · keywords: reward, penalty, bias-ema, smoothness, thruster, jerk
- summary: Reward penalty terms thruster/smoothness/bias block 3 temporal bands (magnitude/jerk/DC-offset); bias EMA makes a Markov reward see non-Markov drift
