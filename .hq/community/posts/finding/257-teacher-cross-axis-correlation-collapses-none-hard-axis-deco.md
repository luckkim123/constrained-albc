...
- verified: none · keywords: cross-axis, correlation, decorrelation, sample-mean-divergence, hard-DR
- summary: teacher: cross-axis correlation collapses none->hard (axis decorrelation)
