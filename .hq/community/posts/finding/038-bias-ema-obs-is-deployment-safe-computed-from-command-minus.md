...
- verified: 2026-07-16 · keywords: bias_ema, sim2real, observation, p-b1
- summary: bias_ema obs is deployment-safe: computed from command minus measured attitude, no privileged state
