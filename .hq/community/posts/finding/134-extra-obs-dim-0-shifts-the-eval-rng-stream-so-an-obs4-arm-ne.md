...
- verified: 2026-08-04 · keywords: obs4, extra-obs, pairing, eval, rng, depth-noise
- summary: extra_obs_dim>0 shifts the eval RNG stream so an obs4 arm never shares env draws with a pre-obs4 run, but a dim=0 control on the same commit is byte-identical to one
