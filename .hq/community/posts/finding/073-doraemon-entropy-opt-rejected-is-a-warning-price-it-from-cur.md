...
- verified: 2026-08-09 · keywords: albc, doraemon, curriculum, dr, entropy, monitoring
- summary: DORAEMON Entropy opt rejected is a WARNING: price it from curriculum_trajectory.json, not the log (successful expansions are never logged)
