...
- verified: 2026-07-23 · keywords: reward, penalty, rescaling, exchange-rate, tuning, constraint-trpo
- summary: Penalty-vs-objective exchange rate (deg of attitude error bought per penalty term) is the rescaling evidence, not the 1% reward share; all four penalties together buy only 0.125 deg
