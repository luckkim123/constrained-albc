...
- verified: none · keywords: dr-harder, E5, alpha, OOD, generalization-gap, roll
- summary: E5 alpha075 OOD per-axis generalization gap (universal failure = roll DC-bias doubles OOD)
