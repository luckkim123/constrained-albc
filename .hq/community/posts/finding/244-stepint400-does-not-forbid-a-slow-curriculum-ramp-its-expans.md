...
- verified: 2026-08-09 · keywords: doraemon, curriculum, step_interval, kl_ub, budget, citation-correction
- summary: stepint400 does not forbid a slow curriculum ramp: its expansion budget was 2.40 KL against the 3.12 needed to saturate, so it tested under-saturation rather than the knob
