...
- verified: 2026-07-30 · keywords: scaling, dgx, gb10, throughput, memory, doraemon
- summary: 32768 envs FIT on the DGX GB10 (83.2/121.7 GB peak, no fallback) at 34.73 s/iter, but per-doubling cost is degrading (1.78x -> 1.90x) and a 200-iter probe cannot see DORAEMON at all (step_interval 250)
