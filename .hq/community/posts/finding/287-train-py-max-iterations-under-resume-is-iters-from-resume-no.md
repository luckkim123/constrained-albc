...
- verified: none · keywords: train.py, resume, max_iterations, launch, gotcha, budget
- summary: train.py --max_iterations under --resume is iters-FROM-resume, not an absolute target (e3 got +10000 not +5000)
