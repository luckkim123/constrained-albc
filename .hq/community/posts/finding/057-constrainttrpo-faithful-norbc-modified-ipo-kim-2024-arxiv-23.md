...
- verified: 2026-07-12 · keywords: constraint_trpo, NORBC, IPO, barrier, provenance, feasibility
- summary: ConstraintTRPO = faithful NORBC Modified-IPO (Kim 2024, arXiv:2308.12517); standardized-vs-raw barrier + soft feasibility are NORBC design not bugs; only the 1e-8 barrier clamp is code-level (no functional fix)
