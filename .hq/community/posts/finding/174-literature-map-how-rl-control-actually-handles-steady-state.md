...
- verified: 2026-07-20 · keywords: literature, steady-state-error, integral-action, bias-ema, reward-shaping, policy-invariance
- summary: Literature map: how RL control actually handles steady-state error (cross-domain) -- nobody has eliminated it; our r_bias reward penalty is a single-paper idea, our encoder is the field's top-ranked mechanism with no UUV precedent
