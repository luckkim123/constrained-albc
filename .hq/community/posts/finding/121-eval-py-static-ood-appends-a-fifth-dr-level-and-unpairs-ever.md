...
- verified: 2026-08-14 · keywords: eval, pairing, ood, decision-floors, protocol, instrument
- summary: eval.py static --ood appends a fifth DR level and unpairs every cross-run comparison at soft/medium/hard
