...
- verified: none
- summary: eval.py student-mode restores the extra-obs env config for GEN-1 only: a gen-2 student carries extra_obs_dim=0, so the restore block is skipped and env.use_extra_policy_obs=True must be passed explicitly or the env builds 72D against a 76D student
