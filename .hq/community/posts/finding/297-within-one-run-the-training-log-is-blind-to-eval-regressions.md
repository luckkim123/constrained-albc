...
- verified: none · keywords: training-dynamics, reward-decomposition, eval, regression-detection, tensorboard, methodology
- summary: Within one run the training log is blind to eval regressions: a 34 percent none-level degradation moved every TB metric under 1 percent (bounds the cross-treatment reward-decomposition rule)
