...
- verified: 2026-08-05 · keywords: koopman, generalization, domain-randomization, exchange-rate, decision
- summary: On the ALBC plant the binding prediction error is transfer to held-out plants, not model class, so lifting does not touch the dominant term
