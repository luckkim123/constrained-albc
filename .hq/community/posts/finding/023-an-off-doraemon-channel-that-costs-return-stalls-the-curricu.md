...
- verified: 2026-07-13 · keywords: doraemon, curriculum, stall, mode-infeasible, performance_lb, alpha-floor
- summary: an off-DORAEMON channel that costs return stalls the curriculum below the alpha floor (mode -2 entire run)
