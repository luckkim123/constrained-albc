...
- verified: 2026-07-09 · keywords: albc, envs-main, sim-to-real, deployment, vibration, jitter
- summary: Real-robot deployment vibration: differential diagnosis by sim-to-real gap channel (which DR/noise probe to reach for)
