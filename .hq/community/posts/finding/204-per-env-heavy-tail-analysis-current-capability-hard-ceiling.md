...
- verified: 2026-06-14 · keywords: heavy-tail, per-env, fault, fault-tolerant, thruster-failure, sensor-noise
- summary: per-env heavy-tail analysis: current capability, hard ceiling, and what fault-tolerant-control research needs added
