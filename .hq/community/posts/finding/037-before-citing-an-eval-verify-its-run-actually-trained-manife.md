...
- verified: 2026-08-14 · keywords: provenance, verification, eval, procedure, orphan-artifact
- summary: Before citing an eval, verify its run actually trained: manifest status, log directory, wandb, checkpoint count
