...
- verified: 2026-07-23 · keywords: albc, envs-main, arm, actuator, joint-dr, sim-to-real
- summary: Joint DR params (Kp/Kd/effort/friction) need NO dedicated measurement: PD-gain center already measured, effort/friction are DR-bypass by design
