...
- verified: 2026-07-11 · keywords: joint1, reward, branch-divergence, reward-md-stale, line-cite-drift, latency-dr
- summary: joint1_centering reward is REMOVED on main (6-term) but ALIVE on exp/latency-dr (7-term); reward.md doc is main-stale
