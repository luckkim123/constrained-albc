...
- verified: 2026-08-14 · keywords: stonefish, servo, chatter, aliasing, odom, actuator
- summary: Stonefish Servo position mode bang-bangs at the deployed 1.0/1.0 per-step gains, and the 50 Hz odom aliased the chatter away while biasing base yaw rate +41 percent (fixed at 0.1/0.1, interim)
