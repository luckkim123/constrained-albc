...
- verified: 2026-05-26 · keywords: student, distillation, TCN, GRU, roll, heavy-tail
- summary: Student distillation roll heavy-tail is a teacher-policy property (TCN==GRU), not a distillation artifact
