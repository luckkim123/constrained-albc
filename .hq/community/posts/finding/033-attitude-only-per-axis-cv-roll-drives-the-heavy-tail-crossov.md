...
- verified: none · keywords: heavy-tail, CV, roll, pitch, yaw, per-axis
- summary: attitude_only per-axis CV: roll DRIVES the heavy-tail crossover, yaw is the EXTREME tail
