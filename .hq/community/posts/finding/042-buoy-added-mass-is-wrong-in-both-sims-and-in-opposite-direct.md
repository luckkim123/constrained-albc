...
- verified: 2026-08-05 · keywords: sim-to-real, stonefish, buoy, added-mass, hydrodynamics, domain-randomization
- summary: Buoy added mass is wrong in BOTH sims and in opposite directions: Isaac 3.8-8.2x below the geometric value, Stonefish 3.5-5.7x above it via an isotropic average of a dimensionally broken axial term; recentering Isaac onto Stonefish moves it further from reality
