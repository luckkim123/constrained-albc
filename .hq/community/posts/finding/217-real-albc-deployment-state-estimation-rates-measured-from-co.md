...
- verified: 2026-08-03 · keywords: rates, deployment, agent-jetson, staleness, aliasing
- summary: Real ALBC deployment state-estimation rates measured from code: attitude+gyro at most ~25 Hz (loop_speed/4, self-telemetered in the sensors DEPTH field), joints 10 Hz, control 50 Hz -- the real policy runs on zero-order-held stale observations, so 50 Hz Stonefish odom is already faster than reality
