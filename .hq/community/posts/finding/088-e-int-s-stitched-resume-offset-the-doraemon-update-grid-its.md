...
- verified: 2026-07-28 · keywords: doraemon, curriculum, fault_severity, e-int, resume, stitched-run
- summary: E-int's stitched resume offset the DORAEMON update grid: its fault_severity reads 0.0770 iteration-matched (iter 4749) but 0.0901 at actual run end (iter 4999)
