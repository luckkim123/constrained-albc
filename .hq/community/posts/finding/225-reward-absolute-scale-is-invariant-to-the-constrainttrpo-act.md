...
- verified: 2026-06-14 · keywords: reward, scale, advantage-normalization, trpo, doraemon, entropy-coef
- summary: Reward absolute scale is invariant to the ConstraintTRPO actor; only term ratios matter (3 un-normalized leak paths)
