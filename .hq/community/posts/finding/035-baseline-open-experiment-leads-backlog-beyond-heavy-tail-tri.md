...
- verified: 2026-07-23 · keywords: backlog, experiment-roster, next-experiment, heavy-tail, doraemon-per-axis-gate, command-box
- summary: Baseline open experiment-leads backlog (beyond heavy-tail): triage by value x launchability with blockers
