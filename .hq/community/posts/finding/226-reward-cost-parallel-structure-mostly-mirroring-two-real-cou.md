...
- verified: 2026-07-12 · keywords: constraint, constraint_trpo, cost_critic, reward_cost_parallel, ipo, grad_clip
- summary: reward/cost parallel structure: mostly mirroring, two real couplings (value grad-clip over the union throttles reward critic; feasibility J_C uses GAE-return so constraint level inherits lambda_c + cost-critic bias)
