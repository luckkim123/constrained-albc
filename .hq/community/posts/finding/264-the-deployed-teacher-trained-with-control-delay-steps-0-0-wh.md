...
- verified: 2026-08-15 · keywords: albc, deployment, latency, staleness, control-delay, doraemon
- summary: The deployed teacher trained with control_delay_steps (0,0) while the robot serves observations 1.2 to 4.7 control steps stale, and DORAEMON has no dim to cover it
