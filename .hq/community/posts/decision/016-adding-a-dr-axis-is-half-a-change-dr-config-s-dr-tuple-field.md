...
- verified: 2026-07-23 · keywords: domain-randomization, dr_config, eval-protocol, none-level, silent-failure, checklist
- summary: Adding a DR axis is half a change: dr_config's _DR_TUPLE_FIELDS / _TRUE_NOMINAL_PHYSICS must both register it or the none level silently keeps the training band
