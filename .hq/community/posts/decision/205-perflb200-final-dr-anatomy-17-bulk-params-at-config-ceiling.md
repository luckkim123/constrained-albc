...
- verified: 2026-07-20 · keywords: doraemon, dr-difficulty, perflb200, deployment-ood, curriculum-budget
- summary: perflb200 final DR anatomy: 17 bulk params at config ceiling (uniform), 3 deployment-relevant params (ocean_current/obs_noise/payload_cog) are TIME-limited not feasibility-limited
