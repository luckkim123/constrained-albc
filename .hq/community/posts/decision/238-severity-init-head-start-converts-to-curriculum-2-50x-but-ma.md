...
- verified: none · keywords: fault-tolerant-control, ftc, fault_severity, doraemon, curriculum, m4
- summary: Severity-init head start converts to curriculum (2.50x) but makes m4-dead fault rejection 2.9-5.5x WORSE -- raising trained fault severity is not a route to fault tolerance on this plant
