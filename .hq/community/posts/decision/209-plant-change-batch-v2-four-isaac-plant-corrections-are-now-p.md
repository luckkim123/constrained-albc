...
- verified: 2026-08-14 · keywords: plant, batch, retrain, buoy, added-mass, damping
- summary: Plant-change batch v2: four Isaac plant corrections are now pending and each alone forces a teacher retrain, so they are batched behind one sizing gate instead of decided individually
