...
- verified: 2026-07-23 · keywords: albc, envs-main, retrain-campaign, sim-to-real-audit, baseline-retrain, manifest
- summary: Next from-scratch retrain manifest: what rides on the post-TAM baseline retrain (sim fixes + learning-dynamics experiments)
