...
- verified: 2026-07-29 · keywords: environment, cudnn, student, distillation, infra
- summary: Container cuDNN is cu13 against cu128 torch: every conv1d fails, student distillation is 70x slower with the workaround
