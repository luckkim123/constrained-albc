...
- verified: none · keywords: bias_ema, observability, use_bias_ema_obs, heavy-tail, authority-limited, dc-bias
- summary: bias_ema observability (69->72D) improves absolute attitude tracking + CV but does NOT shrink the hard-DR heavy-tail ratio -- the DC-bias tail is authority-limited (p7_tail e2)
