...
- verified: 2026-08-05 · keywords: stonefish, hydrodynamics, damping, yaw, rotational-drag, cylinder-approximation
- summary: Stonefish rotational drag is a distributed integral with no separate rotational term, so hull yaw pressure drag is exactly zero by construction -- the 45.5x yaw damping gap is an artifact and roll/pitch is corrupted by a force-derived torque correction
