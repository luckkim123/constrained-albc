...
- verified: 2026-07-27 · keywords: units, os_env_mean, ss_error, decision-floor, machine-isolation, paired-seed
- summary: Eval metric units and decision floors: os_env_mean is percent-of-step (roll steps 30 deg), ss_error is degrees; paired screening floors and the machine-isolation rule
