...
- verified: 2026-07-27 · keywords: engine-gap, omx, tensorboard, compare, eval, fault
- summary: engine-gap: omx reduce tb-final unusable here (CLI on system python without tensorboard) + no paired-condition comparison in the analysis package
