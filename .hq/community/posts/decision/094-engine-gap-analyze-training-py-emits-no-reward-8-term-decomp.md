...
- verified: 2026-07-23 · keywords: engine-gap, reward-decomposition, analyze_training, constraint-naming, CORRECTION, implemented
- summary: engine-gap: analyze_training.py emits no reward 8-term decomposition scalars
