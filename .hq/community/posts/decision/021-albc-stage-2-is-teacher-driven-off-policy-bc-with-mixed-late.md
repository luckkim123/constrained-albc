...
- verified: 2026-07-21 · keywords: distillation, student, off-policy, methods, rma, taxonomy
- summary: ALBC stage 2 is teacher-driven off-policy BC with mixed latent+action labels (differs from RMA/HORA on both axes)
