...
- verified: 2026-07-23 · keywords: wiki, gc, delete, convention, discoverability
- summary: omx wiki has no delete subcommand by design: removal is gc-apply, duplicates come from add-with-new-title
