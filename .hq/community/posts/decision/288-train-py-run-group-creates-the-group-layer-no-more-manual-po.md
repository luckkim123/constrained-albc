...
- verified: 2026-06-12 · keywords: albc, conventions, directory, run_group, group, train
- summary: train.py --run_group creates the <group> layer (no more manual post-move)
