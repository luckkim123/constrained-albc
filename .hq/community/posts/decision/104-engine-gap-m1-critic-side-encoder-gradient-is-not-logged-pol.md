...
- verified: none · keywords: engine-gap, encoder, M1, constraint_trpo, proposed
- summary: engine-gap: M1 critic-side encoder gradient is not logged (Policy/encoder_grad_norm is actor-path only)
