...
- verified: 2026-07-14 · keywords: open-actionable, ledger, pre-retrain-gate, launch-gate, needs-action, tam
- summary: OPEN-ACTIONABLE LEDGER: read before any sim-plant code change or baseline launch (TAM/IMU HARD-gate + experiment backlog)
