...
- verified: none · keywords: ee-action, joint1-drift, leak-removal, settle-position, bimodal
- summary: ee_leak=0 + k_anchor=0 does NOT blow up joint1 settle (Pade/IK clamp bounds it); settle still bimodal
