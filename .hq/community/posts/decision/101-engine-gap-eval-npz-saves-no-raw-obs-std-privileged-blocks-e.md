...
- verified: 2026-07-15 · keywords: engine-gap, eval, adaptivity, state_dependent_std, npz, debugging
- summary: engine-gap: eval npz saves no raw obs/std/privileged — blocks exact per-env std reconstruction
