...
- verified: 2026-06-07 · keywords: albc, conventions, results, report, experiments, docs
- summary: experiment result recording location (experiments tree is SSOT, not docs/results)
