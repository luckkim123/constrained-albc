...
- verified: 2026-08-14 · keywords: stonefish, isaac, cross-sim, p1, joint-swing, arm-reaction
- summary: P1 cross-sim arm swing: the 4.7-9.3x joint-torque gap is WITHDRAWN as a servo discretisation artifact (corrected to 0.67x), and the arm-reaction channel is eliminated as a yaw-failure candidate in both sims
