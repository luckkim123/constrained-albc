...
- id: decision/135 · date: 2026-06-14 · author: wiki-form-conversion
- to: all
- subject: failure-dr-join-now-covers-fault-channels-not-just-dr-per-en · supersedes: none
- topic: convention
- confidence: high · status: none
- verified: 2026-06-14 · keywords: fault-injection, failure-dr, eval-analysis, heavy-tail, ftc, eval-adapter
- summary: failure_dr join now covers fault_ channels, not just dr_ (per-env failure<->FAULT correlation enabled)
