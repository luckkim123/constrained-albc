...
- verified: none · keywords: p7_tail, budget, extend10k, doraemon, heavy-tail, regression
- summary: e3 extend10k REGRESSED the policy — training budget is NOT the p7_tail tail lever; keep 5000 iters
