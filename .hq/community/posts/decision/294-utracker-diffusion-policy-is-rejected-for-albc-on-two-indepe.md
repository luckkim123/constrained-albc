...
- verified: 2026-07-21 · keywords: albc, utracker, diffusion, imitation-learning, distillation, rma
- summary: UTracker diffusion policy is rejected for ALBC on two independent grounds, and its repo disagrees with its own paper on all six axes (do not use it as a comparison axis)
