...
- verified: none
- summary: Arm B is a dictionary-only control, not a Koopman result: it fitted no operator, so citing its NULL as evidence against Koopman is an indefensible overclaim
