...
- verified: 2026-07-23 · keywords: ablation, task-registration, obs-dim, runner, comparison-set
- summary: Attitude-only ablation arms registered; policy_obs_dim sync must cover every encoder-capable runner
