...
- verified: none · keywords: doraemon, tensorboard, beta, metric-definition, label-vs-implementation, trap
- summary: DORAEMON/mean and DORAEMON/std TB tags are RAW PHYSICAL UNITS, not normalized xi -- Beta(a,b) inversion from them is valid for only 3 of the 20 params
