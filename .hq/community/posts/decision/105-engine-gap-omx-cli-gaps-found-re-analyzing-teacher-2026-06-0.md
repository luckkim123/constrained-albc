...
- verified: 2026-07-12 · keywords: engine-gap, omx-harness, cli-bug, exp-analyze, silent-empty, wiki
- summary: engine-gap: omx CLI gaps found re-analyzing teacher (2026-06-06 round 2)
...
Extension of [[engine_gap_analyze_training_py_emits_no_reward_8_term_decomposit]]: the empty-output trap is NOT limited to the diagnostic ENGINE (analyze_training.py). The omx CLI REDUCE/PLOT verbs themselves return empty on MISUSE without erroring, which a goal-less session copies as 'no data'.
...
## Update (2026-07-12T14:17:28.825256)

Update (2026-07-12, wiki curation): [ENGINE-GAP 2] is RESOLVED — `omx wiki read --slug <slug> [--root]` exists in the current omx CLI (exercised during this curation pass; loud-fails on a missing slug as specced). Status flipped for GAP 2 only; the other gaps on this page were not re-audited in this pass.

## Provenance (carried from the omx wiki frontmatter)

- sources: ["diagnose-20260606-194621", "diagnose-20260606-173330", "wiki-curation-2026-07-12"]
