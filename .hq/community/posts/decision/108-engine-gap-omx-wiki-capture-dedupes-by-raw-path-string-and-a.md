...
- verified: 2026-08-14 · keywords: engine-gap, omx, wiki, capture-flush, dedupe, hygiene
- summary: engine-gap: omx wiki capture dedupes by raw path string and appends without an equality check, so one report can be captured twice byte-identically
