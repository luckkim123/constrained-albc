...
- verified: 2026-06-08 · keywords: exp-analyze, report-coverage, re-analysis, depth-regression, dr_harder
- summary: coverage lint ok is a floor not a quality gate; re-analysis uses OLD report as base, never shrinks
