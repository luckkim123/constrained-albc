...
- verified: 2026-08-14 · keywords: omx, wiki, lint, curation, triage, meta
- summary: How to read omx wiki lint on this corpus: oversized means accumulated updates, and contradiction-candidate is a tag-collision heuristic that never reads a claim
