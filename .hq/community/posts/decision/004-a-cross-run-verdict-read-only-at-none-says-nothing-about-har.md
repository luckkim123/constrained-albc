...
- verified: 2026-08-09 · keywords: eval, doraemon, anchor, cross-run, methodology, num_envs
- summary: A cross-run verdict read only at none says nothing about hard: anchor asymmetry makes the hard exams incomparable, and re-scoring under one saturated anchor is 30 minutes with no retraining
