...
- verified: none · keywords: joint1, drift, constraint, IPO, pitch-trim, recovery
- summary: Arm A (measured-angle joint1 constraint) RECOVERS, not diverges — the earlier divergence verdict was an early-stop artifact
