...
- verified: 2026-08-14 · keywords: engine-gap, latent, student, distillation, metric-definition, r2
- summary: engine-gap: the latent fidelity ratio has no owning module, and it must be reported against per-dim R2 because their divergence is the diagnostic
