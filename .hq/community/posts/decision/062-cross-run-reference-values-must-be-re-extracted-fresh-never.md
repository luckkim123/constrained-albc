...
- verified: 2026-06-08 · keywords: cross-run, carry-forward, stale, baseline, teacher, report-coverage
- summary: cross-run reference values must be RE-EXTRACTED fresh, never carried forward (E4 stale-teacher-column gate)
