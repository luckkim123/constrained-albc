...
- verified: 2026-07-27 · keywords: doraemon, curriculum, confound, experiment-design, p7_tail, comparability
- summary: DORAEMON reactivity makes every single-variable probe two-variable: the curriculum is the uncontrolled second variable (p7_tail e1/e3/e4)
