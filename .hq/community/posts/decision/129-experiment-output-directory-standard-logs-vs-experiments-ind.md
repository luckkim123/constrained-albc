...
- verified: 2026-06-30 · keywords: albc, conventions, directory, layout, run_id, experiments
- summary: experiment output directory standard (logs vs experiments index tree)
