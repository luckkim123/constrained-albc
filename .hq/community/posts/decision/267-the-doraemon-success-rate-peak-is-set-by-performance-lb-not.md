...
- verified: 2026-07-20 · keywords: doraemon, success-rate, performance_lb, alpha-floor, curriculum-starvation, p-a2
- summary: The DORAEMON success_rate PEAK is set by performance_lb, not policy quality: lb=250 peaks 0.63-0.67 and ends CONTRACTED; lb=200 peaks 0.97 and reaches the config ceiling
