...
- verified: 2026-07-12 · keywords: constraint, threshold, budget, actuator, effort-limit, velocity-limit
- summary: Constraint threshold/budget tuning: thresholds split into hard physical rails (soft-inside-hard vs PhysX cap) vs soft shaping thresholds; budgets mostly no-op (9/10 slack); co-tune one at a time
