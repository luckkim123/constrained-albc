...
- verified: none · keywords: c3, provenance, baseline, student, distillation, dirty-tree
- summary: C3's dirty-tree provenance doubt is CLOSED: a dim=0 control on commit d81e2fd reproduces C3's iteration 0 bit-identically, so every student_distill_eint comparison against C3 stands
