...
- verified: none · keywords: eval, methodology, stop-rule, paired-test, plateau, scheduling
- summary: An eval schedule too sparse to resolve the curve manufactures a false plateau and fires the stop rule on an artifact
