...
- verified: 2026-07-11 · keywords: reward-weight-tuning, two-phase, baseline, retrain, experiment-plan, envs-main
- summary: Next experiment workflow: pick a baseline, train once, then re-tune reward weights and retrain (two-phase)
