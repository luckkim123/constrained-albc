...
- verified: 2026-08-05 · keywords: latency, delay, domain-randomization, sim2real, experiment-idea, control_delay
- summary: experiment idea: latency/transport-delay DR (sensor-obs + control-action lag) -- infra exists (isaaclab DelayBuffer) but unused; DelayedPD failed before
