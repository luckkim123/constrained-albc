...
- id: decision/119 · date: 2026-08-04 · author: wiki-form-conversion
- to: all
- subject: eval-py-rebuilds-env-cfg-from-hydra-defaults-so-obs-widening · supersedes: none
- topic: convention
- confidence: high · status: resolved
- verified: 2026-08-05 · keywords: eval, trap, hydra, observation-space, koopman
- summary: eval.py rebuilds env cfg from Hydra defaults, so obs-widening flags must be re-passed at eval time
