...
- verified: 2026-07-27 · keywords: engine-gap, analyze_training, omx, debugging
- summary: engine-gap: analyze_training.py needs the logs/ run dir, not the experiments/ run dir (events under train symlink)
