...
- verified: 2026-06-27 · keywords: engine-gap, eval, flat-target, joint1, debugging
- summary: engine-gap: flat-target eval records joint1 trajectory but renders no drift plot
