...
- verified: 2026-08-14 · keywords: engine-gap, omx, wiki, quality, lint, scoring
- summary: engine-gap: qualityScore is computed on the incoming append only, so a one-line housekeeping update permanently downgrades a rich page
