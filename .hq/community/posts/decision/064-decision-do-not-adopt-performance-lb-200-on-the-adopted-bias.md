...
- verified: 2026-07-16 · keywords: performance_lb, doraemon, bias_ema, p-a8, perflb200, adoption
- summary: DECISION: do NOT adopt performance_lb=200 on the adopted bias_ema-ON config -- success 0.989 makes the feasibility constraint inert (the lb=68 failure class)
