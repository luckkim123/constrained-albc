...
- verified: 2026-07-23 · keywords: eval, comparability, doraemon-dr-from, common-exam, confound, methodology
- summary: Cross-run DR comparability: eval.py --doraemon-dr-from already provides a common test distribution; p7_tail knew and declined, judging a robustness campaign on nominal-only
