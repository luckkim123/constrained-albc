...
- verified: 2026-07-27 · keywords: engine-gap, analyze_training, doraemon, curriculum, omx
- summary: engine-gap: DORAEMON per-parameter curriculum expansion is invisible in the text diagnosis (TIER 2 prints only success/ess/mode)
