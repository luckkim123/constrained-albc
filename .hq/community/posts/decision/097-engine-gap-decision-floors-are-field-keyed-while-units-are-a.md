...
- verified: 2026-08-14 · keywords: engine-gap, decision-floor, eval, units, yaw, lin-vel
- summary: engine-gap: decision floors are field-keyed while units are axis-keyed, so steady-state error is unadjudicated on 4 of 7 axes
