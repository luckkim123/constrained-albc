...
- verified: 2026-08-05 · keywords: doraemon, curriculum, kl_ub, performance_lb, step_interval, max_iterations
- summary: Curriculum recalibration protocol: widening the DR box requires re-tuning budget (kl_ub x n_updates) AND performance_lb together -- not a single-variable probe
...
## Update (2026-07-20T08:43:43.982875)
