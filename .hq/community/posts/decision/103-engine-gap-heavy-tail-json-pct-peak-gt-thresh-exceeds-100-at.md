...
- verified: 2026-07-23 · keywords: engine-gap, heavy-tail, ood, eval-adapter, debugging
- summary: engine-gap: heavy_tail.json pct_peak_gt_thresh exceeds 100% at ood level (denominator bug)
...
## Update (2026-07-23T07:42:44.636172)

2026-07-23 curation: status set to resolved -- matches body's resolved-by-refactor verdict (2026-07-13).
