...
- verified: 2026-06-05 · keywords: engine-gap, eval-adapter, periodic, segmented, coverage, debugging
- summary: engine-gap: eval adapter covers static + segmented; periodic still unsupported
