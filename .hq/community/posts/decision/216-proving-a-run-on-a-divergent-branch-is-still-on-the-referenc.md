...
- verified: 2026-07-30 · keywords: plant-parity, branch-hygiene, config-audit, teacher
- summary: Proving a run on a divergent branch is still on the reference plant
