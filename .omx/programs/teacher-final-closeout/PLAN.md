...
| E-int | integration retrain (anchor + B0c band + fault-DR); **QUEUED 2026-07-27 — proposal `next-20260727-155500` (lint ok, independent review approve + 2 threshold minors applied), pending-launch artifact `.omx/runs/trpo_eint_s30_PLACEHOLDER/`, awaiting human launch approval**; D-a and D-b both adopted (user); whether E-ftc1 precedes it pends the user's re-judgment of E-ftc1 (the user declined an "8k extension" reading 2026-07-27; the as-designed probe is 5k-fixed, see 12.2 E-ftc1) | workstation, ~5 h | becomes the final teacher -> C4 |
