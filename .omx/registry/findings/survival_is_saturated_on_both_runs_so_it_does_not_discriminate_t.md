---
title: "Survival is saturated on both runs, so it does not discriminate — the trade is e"
...
# Survival is saturated on both runs, so it does not discriminate — the trade is e

Survival is saturated on both runs, so it does not discriminate — the trade is entirely in error/transient quality, not stability.

[EVIDENCE: summary.json survival_pct — 8k = 100/100/100/100; 5000 = 100/100/100/98 (none/soft/medium/hard)]
[CONFIDENCE: HIGH]
