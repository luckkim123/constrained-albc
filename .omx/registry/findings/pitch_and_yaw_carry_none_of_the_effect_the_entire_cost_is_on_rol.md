---
title: "Pitch and yaw carry none of the effect; the entire cost is on roll."
...
# Pitch and yaw carry none of the effect; the entire cost is on roll.

Pitch and yaw carry none of the effect; the entire cost is on roll.

[EVIDENCE: summary.json — hard pitch ss_error IMPROVES -0.0183 deg, hard pitch CV 102% -> 135% vs roll 130% -> 303%; yaw ss_error deltas span -0.0007 to -0.0002 rad/s at all four levels]
[CONFIDENCE: HIGH]
