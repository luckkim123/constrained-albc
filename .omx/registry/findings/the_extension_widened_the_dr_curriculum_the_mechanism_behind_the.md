---
title: "The extension WIDENED the DR curriculum — the mechanism behind the whole trade. "
...
# The extension WIDENED the DR curriculum — the mechanism behind the whole trade. 

The extension WIDENED the DR curriculum — the mechanism behind the whole trade. More iterations = more expansions (step_interval clock), so the DR distribution ends markedly wider than the 5000-run's.

[EVIDENCE: analyze_training.py [TIER 2] DORAEMON + [TIER 3] DR + TB entropy_before]
[CONFIDENCE: HIGH]
