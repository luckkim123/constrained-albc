---
title: "Transients are preserved and hard-level jitter is if anything slightly better."
...
# Transients are preserved and hard-level jitter is if anything slightly better.

Transients are preserved and hard-level jitter is if anything slightly better.

[EVIDENCE: `summary.json` roll `rise_time` 0.4937 -> 0.4383 (none) through 0.6236 -> 0.6330 (hard), and roll `ss_jitter` 0.3084 -> 0.2853 with `ss_jitter_std` 1.2262 -> 1.0258 at hard]
[CONFIDENCE: HIGH]
