---
title: "The channels are live and the zero-order hold is physically present in this arm "
...
# The channels are live and the zero-order hold is physically present in this arm 

The channels are live and the zero-order hold is physically present in this arm too, at SNR values within 1% to 6% of B2's, so nothing about the input side distinguishes the two runs.

[EVIDENCE: `student_extra_summary_{none,soft,medium,hard}.json` in `static_260803_233436`; B2's counterparts are 2.227 / 2.456 / 3.218 / 4.214]
[CONFIDENCE: HIGH]
...
[EVIDENCE: the side-by-side table above, from `student_extra_summary_{none,soft,medium,hard}.json` in `static_260803_233436` and `static_260803_220328`]
[CONFIDENCE: HIGH]
