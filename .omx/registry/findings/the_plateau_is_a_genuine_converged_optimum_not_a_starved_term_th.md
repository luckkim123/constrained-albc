---
title: "The plateau is a genuine converged optimum, not a starved term: the two tracking"
...
# The plateau is a genuine converged optimum, not a starved term: the two tracking

The plateau is a genuine converged optimum, not a starved term: the two tracking terms carry the reward and both are healthy-positive; penalty terms are near-zero drag.

[EVIDENCE: analyze_training.py TIER 3 Rewards: att_rp 6.23, yaw_vel 1.30, bias -0.03, smoothness -0.02, thruster -0.03, torque -0.06, total 7.39]
[CONFIDENCE: HIGH]
