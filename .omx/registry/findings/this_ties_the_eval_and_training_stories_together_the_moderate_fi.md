---
title: "This ties the eval and training stories together: the moderate final DR is exact"
...
# This ties the eval and training stories together: the moderate final DR is exact

This ties the eval and training stories together: the moderate final DR is exactly why the post-TAM hard/ood levels are "easier in absolute terms" than they sound, reinforcing that cross-run hard/ood comparison must stay qualitative.

[EVIDENCE: doraemon success 0.40 + DORAEMON run-relative-DR caveat (wiki eval_py_static_doraemon_dr_grades_each_run_on_its_own_learned_dr)]
[CONFIDENCE: MED]
