...
> **SUPERSEDED 2026-06-05** by `engine_gap_eval_adapter_covers_static_segmented_periodic_still_u.md` — segmented is now IMPLEMENTED (switching.py delegation); only periodic remains an engine-gap. See that page.
