---
title: "The DORAEMON curriculum group is absent by design: `configure_env_for_student` d"
...
# The DORAEMON curriculum group is absent by design: `configure_env_for_student` d

The DORAEMON curriculum group is absent by design: `configure_env_for_student` disables DORAEMON and substitutes a static hard box for the whole distillation, which is the same mechanism that makes `none` the off-distribution end in the generalization section.

[EVIDENCE: the by-name check above; 0 tags under the `DORAEMON/` prefix]
[CONFIDENCE: HIGH]
