---
title: "Pitch is the box-sensitive axis to watch: hard-pitch ss_error grows ~80% (0.295 "
...
# Pitch is the box-sensitive axis to watch: hard-pitch ss_error grows ~80% (0.295 

Pitch is the box-sensitive axis to watch: hard-pitch ss_error grows ~80% (0.295 -> 0.532deg) when the box doubles, far more than roll's ~15% floor rise — the full envelope stresses pitch most.

[EVIDENCE: summary.json pitch hard ss_error MATCHED 0.295 vs FULL 0.532]
[CONFIDENCE: HIGH]
