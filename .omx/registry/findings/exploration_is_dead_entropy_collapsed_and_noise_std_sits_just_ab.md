---
title: "Exploration is dead — entropy collapsed and noise_std sits just above the min_st"
...
# Exploration is dead — entropy collapsed and noise_std sits just above the min_st

Exploration is dead — entropy collapsed and noise_std sits just above the min_std floor; the std head has nearly stopped moving. This matches the 5000-run and is a campaign-wide property, not an extend8k effect.

[EVIDENCE: analyze_training.py [TIER 1] + [DIAGNOSIS] item 1 + TB final]
[CONFIDENCE: HIGH]
