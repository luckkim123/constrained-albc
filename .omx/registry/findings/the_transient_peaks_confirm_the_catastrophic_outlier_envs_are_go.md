---
title: "The transient peaks confirm the catastrophic outlier envs are gone: worst per-en"
...
# The transient peaks confirm the catastrophic outlier envs are gone: worst per-en

The transient peaks confirm the catastrophic outlier envs are gone: worst per-env peak roll error fell from void 16.4deg (hard) / 7.3deg (ood) to MATCHED 10.1deg / 6.0deg.

[EVIDENCE: eval_adapter heavy-tail peak_max: void hard 16.39, ood 7.26; MATCHED hard 10.14, ood 5.99]
[CONFIDENCE: HIGH]
