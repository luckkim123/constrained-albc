---
title: "Graceful degradation none->ood at the aggregate level: the summary.json generali"
...
# Graceful degradation none->ood at the aggregate level: the summary.json generali

Graceful degradation none->ood at the aggregate level: the summary.json generalization_gap roll ss_error component is small for all three runs (|delta|<0.15deg).

[EVIDENCE: summary.json generalization_gap.roll.ss_error: void +0.055, MATCHED -0.114, FULL -0.142]
[CONFIDENCE: MED]
