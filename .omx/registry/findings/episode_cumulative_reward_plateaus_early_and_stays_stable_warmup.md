---
title: "Episode-cumulative reward plateaus early and stays stable: warmup(1)->plateau(7)"
...
# Episode-cumulative reward plateaus early and stays stable: warmup(1)->plateau(7)

Episode-cumulative reward plateaus early and stays stable: warmup(1)->plateau(7), plateau since ~5% of training, cv=0.024. Reward changepoints at iter 384 and 3402.

[EVIDENCE: engine TIER 1 reward 215.36; TRENDS reward plateau/cv/changepoints]
[CONFIDENCE: HIGH]
