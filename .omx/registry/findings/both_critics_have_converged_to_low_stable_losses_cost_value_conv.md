---
title: "Both critics have converged to low, stable losses; cost_value converging is the "
...
# Both critics have converged to low, stable losses; cost_value converging is the 

Both critics have converged to low, stable losses; cost_value converging is the prerequisite for ConstraintTRPO's constraint advantages to be meaningful (and they are — see constraint).

[EVIDENCE: engine TIER 3 Losses: Loss/value_function 0.954, Loss/cost_value 0.803]
[CONFIDENCE: HIGH]
