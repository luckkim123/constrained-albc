---
title: "A5 (`trpo_budgetslack_260721_181133`) loosened constraints that are not binding."
...
# A5 (`trpo_budgetslack_260721_181133`) loosened constraints that are not binding.

A5 (`trpo_budgetslack_260721_181133`) loosened constraints that are not binding.

[EVIDENCE: A5's change was budgets x100 on `rp_vel_settling` and `manipulability`; measured JC/dk for those terms is 0.550 and 0.118 respectively, against `thruster_util` at 0.805-0.943.]
[CONFIDENCE: HIGH]
