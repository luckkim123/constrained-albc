---
title: "Aggregate latent statistics are indistinguishable across the three runs, so the "
...
# Aggregate latent statistics are indistinguishable across the three runs, so the 

Aggregate latent statistics are indistinguishable across the three runs, so the encoder is not a candidate explanation for the transient difference.
