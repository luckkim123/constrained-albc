---
title: "None of the 20 declared constraint tags exist and `barrier_penalty` is not logge"
...
# None of the 20 declared constraint tags exist and `barrier_penalty` is not logge

None of the 20 declared constraint tags exist and `barrier_penalty` is not logged: IPO constraint handling belongs to teacher training, which this run does not perform.

[EVIDENCE: the by-name table above; 0 tags under the `Constraint/` prefix in all three event files]
[CONFIDENCE: HIGH]
...
[EVIDENCE: the by-name check above; 0 tags under the `Constraint/` prefix]
[CONFIDENCE: HIGH]
