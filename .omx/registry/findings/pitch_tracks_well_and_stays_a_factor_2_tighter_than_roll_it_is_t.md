---
title: "Pitch tracks well and stays a factor ~2 tighter than roll; it is the axis most s"
...
# Pitch tracks well and stays a factor ~2 tighter than roll; it is the axis most s

Pitch tracks well and stays a factor ~2 tighter than roll; it is the axis most sensitive to the command box (see generalization).

[EVIDENCE: summary.json pitch ss_error and CV, 3 runs]
[CONFIDENCE: HIGH]
