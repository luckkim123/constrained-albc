---
title: "At `soft` (still low-DR, closer to fair than hard/medium), roll ss_error and jit"
...
# At `soft` (still low-DR, closer to fair than hard/medium), roll ss_error and jit

At `soft` (still low-DR, closer to fair than hard/medium), roll ss_error and jitter both improve; pitch roughly flat.

[EVIDENCE: summary.json soft level]
[CONFIDENCE: HIGH]
