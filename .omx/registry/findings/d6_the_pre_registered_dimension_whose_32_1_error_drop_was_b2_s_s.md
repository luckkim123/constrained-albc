---
title: "d6 — the pre-registered dimension whose 32.1% error drop was B2's single stronge"
...
# d6 — the pre-registered dimension whose 32.1% error drop was B2's single stronge

d6 — the pre-registered dimension whose 32.1% error drop was B2's single strongest signal — is fully given back by widening: its MSE rises 67.1% and its `R2` returns to negative.

[EVIDENCE: d6 MSE 0.0369 (B2) -> 0.0617 (WIDE), `R2` +0.1991 -> -0.0343, per-dim table above]
[CONFIDENCE: HIGH]
