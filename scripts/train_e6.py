#!/usr/bin/env python3
import _e6_remap  # E6 process-local finder remap -> worktree (must run before constrained_albc import hook)
# Copyright (c) 2026.
...
Usage (run via isaaclab's runtime):
    cd /workspace/isaaclab && ./isaaclab.sh -p \
        ...
        --task Isaac-ConstrainedALBC-TRPO-v0 --num_envs 4 --headless
"""
