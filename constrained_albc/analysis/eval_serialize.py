...
_MAT_VAR_DESC: dict[str, tuple[str, str]] = {
    ...
    "yaw":              ("rad",      "measured yaw heading wrapped to (-pi, pi], shape (T, num_envs)"),
    ...
    "target_yaw_rate":  ("rad",      "commanded yaw HEADING setpoint (key name kept from the rate era), shape (1, T)"),
